  ...
  return (
    <>
      <div className="min-h-screen bg-primary-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-secondary-50 rounded-2xl shadow-xl border border-primary-200 overflow-hidden animate-in fade-in slide-in-from-right-8 duration-300">

          {/* Header */}
          <div className="p-8 pb-4 text-center bg-gradient-to-b from-secondary-50 to-primary-50/20">
            <button
              onClick={onBack}
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-4 pt-2">
            ...
            <button
              ...
              disabled={loading}
              className={`
              w-full py-3 rounded-xl font-bold text-white shadow-lg shadow-primary-200 hover:shadow-primary-300 transition-all flex items-center justify-center gap-2 bg-primary-600 mt-2
            ...
            <p className="text-center text-xs text-slate-400 mt-6">
              Já tem uma conta? <button onClick={onBack} className="text-primary-600 font-bold hover:underline">Fazer Login</button>
            </p>
          </form>
        </div>
      </div>
