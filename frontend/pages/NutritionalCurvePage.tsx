...
const NutritionalCurve: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg shadow-teal-50 border border-teal-100 p-4 md:p-8 flex flex-col h-[450px] md:h-[600px] relative overflow-hidden animate-in fade-in zoom-in-95 duration-500">
      ...
      <div className="relative z-10 mb-4 md:mb-6">
        <h3 className="text-xl md:text-2xl font-bold text-teal-800 flex items-center gap-3">
